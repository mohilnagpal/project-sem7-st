...
Original file is located at
    https://colab.research.google.com/drive/1TB2X271spc53o9C8EkCPSbpMqrLkH4Es
...
def infotech():
  def itcon(stockname,url1,url2):
    ...
    if(count_revenuefromopqt>45):
        positives.append(" {} has good quarterly results ".format(stock_name))
  ...
  with open("it_stock.txt","w") as fmcgdata:
