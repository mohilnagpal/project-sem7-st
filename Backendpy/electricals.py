...
Original file is located at
    https://colab.research.google.com/drive/1I44Crm8tJZvXLrnBIfDfhpKm7e79vLed
...
def electricals():
  ...
  with open("electricals_stock.txt","w") as fmcgdata:
