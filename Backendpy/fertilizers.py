...
Original file is located at
    https://colab.research.google.com/drive/1aVqa9dCayS92HKwU_pD4U2AURboMvSTZ
...
def fertilizers():
  ...
  with open("fertilizers_stock.txt","w") as fmcgdata:
