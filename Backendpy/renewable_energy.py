# -*- coding: utf-8 -*-
"""Renewable Energy.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xbZmGA5PVhROUYK2fMjP7SIAguLDNE51
...
def ren():
  ...
  with open("renew_stock.txt","w") as fmcgdata:
...
def function_renewable():
  ...
  if(currentMonth in [11,2,5,8] and currentDay==20):
    ...
    try:
      data_file = open("renew_stock.txt","r")
...
#                                    'count_pshares','shareholding','pledged_shares','pepoints','alpha','beta','divy','cagr','st_pe','se_pe','target_price','entry_price','points','cap','roce_ind'])
