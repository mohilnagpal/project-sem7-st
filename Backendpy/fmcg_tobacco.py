...
Original file is located at
    https://colab.research.google.com/drive/1hHoa9FE7H4Zh1xSIK3WzqG5SgNYmBRYk
...
def tobacco():
  ...
  with open("FMCG_stock.txt","w") as fmcgdata:
...
def function_tobacco():
  ...
  if(currentMonth in [11,2,5,8] and currentDay==20):
    ...
    try:
      data_file = open("FMCG_stock.txt","r")
