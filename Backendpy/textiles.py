...
Original file is located at
    https://colab.research.google.com/drive/1O2vrQEQKs8CKCqYekoZRj-rMx5Nf6zzU
...
def tex_sec():
  ...
  with open("textile_stock.txt","w") as fmcgdata:
...
def function_textile():
  ...
  if(currentMonth in [11,2,5,8] and currentDay==20):
    ...
    try:
      data_file = open("textile_stock.txt","r")
