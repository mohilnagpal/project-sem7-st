...
Original file is located at
    https://colab.research.google.com/drive/1iIYuMGY3h2ApYic6-W0znUYm3IkRrhBF
...
def auto_sec():
  ...
  with open("automobile_stock.txt","w") as fmcgdata:
...
def function_automobile():
  ...
  if(currentMonth in [11,2,5,8] and currentDay==20):
    ...
    try:
      data_file = open("automobile_stock.txt","r")
