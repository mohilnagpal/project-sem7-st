...
Original file is located at
    https://colab.research.google.com/drive/1mJKNEORphQJvKbIidSr_Ryg_KkHabIif
...
def retail():
  ...
  with open("dept_stock.txt","w") as fmcgdata:
...
def function_departmental():
  ...
  if(currentMonth in [11,2,5,8] and currentDay==20):
    ...
    try:
      data_file = open("dept_stock.txt","r")
...
#                                    'count_pshares','shareholding','pledged_shares','pepoints','alpha','beta','divy','cagr','st_pe','se_pe','target_price','entry_price','points','count_revenuefromopqt','count_profitqt','count_fa','roce_ind','cap'])
