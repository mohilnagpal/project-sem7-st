...
Original file is located at
    https://colab.research.google.com/drive/1UZ_rcB6AjzTYTFE1qcdPkwA-edYJHuSg
...
def cement_sec():
  def cement(stockname,url1,url2):
    ...
    shareholding=round((data['Mkt Cap (Rs. Cr.)']/data['Previous Close']),2)
    shareholding
  ...
  with open("cement_stock.txt","w") as fmcgdata:
