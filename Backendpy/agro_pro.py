...
Original file is located at
    https://colab.research.google.com/drive/1zA3EMlPt6xQbJGhwnIn_z-u-1mrFR-KT
...
def agroproducts():
  ...
  with open("agrop_stock.txt","w") as fmcgdata:
